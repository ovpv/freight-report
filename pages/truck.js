...
export default class Truck extends Component {
  ...
  getTruckData(id) {
    const trucksJSON = axios(
      `/api?query={truck(id:${id}){id,license,model,earning{monthly,total},expense{monthly,total}}}`
    );
    return trucksJSON;
  }
  componentDidMount() {
    this.getTruckData(this.props.url.query.id)
      .then(data => {
        this.setState({ truck: data.data.data.truck });
      })
            ...
            <div className="mt-5">
              <div className="earning d-flex flex-column justify-content-center mb-3">
                ...
                <table className="table">
                  ...
                  <tbody>
                    <tr>
                      <td>{truck.earning.monthly}</td>
                      <td>{truck.earning.total}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div className="earning d-flex flex-column justify-content-center mb-3">
                ...
                <table className="table">
                  ...
                  <tbody>
                    <tr>
                      <td>{truck.expense.monthly}</td>
                      <td>{truck.expense.total}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
